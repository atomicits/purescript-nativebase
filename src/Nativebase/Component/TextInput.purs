...
import Events (ContentSizeEvent, EventHandler, ScrollEvent, TextInputEvent)
import RNX.PropTypes (Prop)
import React (ReactElement, createElement)
import Unsafe.Coerce (unsafeCoerce)
import Nativebase.ComponentClass (textInputClass)


type TextInputProps eff ref = TextInputPropsEx eff ref ()

type TextInputPropsEx eff ref r = ViewNbPropsEx eff ref
...
textInput :: forall eff ref. Prop (TextInputProps eff ref) -> Array (ReactElement)  -> ReactElement
